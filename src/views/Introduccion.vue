  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-4
      .col-lg-8.my-3.order-1
        ...
        .row.justify-content-center.align-items-center.bg8.mb-4
          .col-lg-4.h-100
            img.img-fluid(src='@/assets/template/images/cf3/2.png' alt='')
          .col-lg-8.bgi
            .p-4
              p.mb-0
      ...
      .col-lg-4.my-3.order-lg-2
        img.img-a.img-t(src='@/assets/template/images/cf3/1.png' alt='')
    .row.justify-content-center
      .col-lg-10.my-3
        .row.justify-content-center.align-items-center.bg7.p-4.brad.text-white.mb-5
          .col-lg-auto
            img.img-a.img-t(src='@/assets/template/images/cf3/3.svg' alt='')
          .col.pt-lg-0.pt-md-4
            p.mb-0
    ...
    .row.justify-content-center.align-items-center        
      .col-lg-12
        figure
          .video
            iframe(width="560" height="315" src="https://www.youtube.com/embed/H-YTgpFnjnU?si=QuV8Q7y2CxudY4X2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
